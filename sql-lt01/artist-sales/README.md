...
- Best-selling album title as `BestAlbum`
- Number of tracks in this album as `TrackCount`
- Total revenue from this album as `Revenue`

Where:
- Group by artist, album to get per-album statistics
- Filter albums that generated more than $20 in revenue
- Best album is determined by highest total revenue
- Order results by revenue from highest to lowest

Note:
- Revenue is multiplication of quantity and unit price
- Round revenue to 2 decimal places
- Count distinct tracks to avoid duplicates
