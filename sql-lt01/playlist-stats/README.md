...
- Number of different genres as `GenreCount`
- Most expensive track price as `MaxPrice`
- Total duration in hours rounded to 2 decimals as `Hours`

Note:
- 1 hour is 3600000 milliseconds
- Include only playlists that:
- Have more than 2 different genres
- Order by number of artists descending

*There is a difference between dividing by a whole or float numbers*
